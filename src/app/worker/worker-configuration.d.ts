/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=src/app/worker/wrangler.jsonc src/app/worker/worker-configuration.d.ts` (hash: 46dc1ebee2bd4c211c1dab8bb0ff518a)
// Runtime types generated with workerd@1.20260708.1 2025-03-10 nodejs_compat
interface __BaseEnv_Env {
	// SESSION_SECRET is a `wrangler secret put` value, not a KV binding —
	// hand-edited here since OAUTH_KV was removed from wrangler.jsonc.
	// Regenerate this file with `wrangler types` after next deploy config
	// change to pick this up from an actual `[vars]`/secret declaration.
