/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=src/app/worker/wrangler.jsonc src/app/worker/worker-configuration.d.ts` (hash: fa59c5b4753853cef516266264832ca5)
// Runtime types generated with workerd@1.20260708.1 2025-03-10 nodejs_compat
interface __BaseEnv_Env {
	OAUTH_KV: KVNamespace;
	TOKEN_STORE: KVNamespace;
	SESSION_CONFIG_STORE: KVNamespace;
}
